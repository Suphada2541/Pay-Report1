...
<div class="card">
	<div class="card-header w3-theme-d5">
		<h3 class="card-title text-white"><i class="fa fa-list-alt"></i> ตารางแสดงรายการ ข้อมูล<b>tb_summonth</b></h3>
	</div>
	<div class="card-body">
		<div class="row">
			...
			<div class="col-sm-12 col-md-9">
				<form class="form-inline well well-sm" name="formSearch" method="post" action="{page_url}/search">
					...
					<option value="monthpr_id">รหัส</option>
					<option value="monthpay">เดือน</option>
					<option value="rf_name_id">รหัสพนักงาน</option>
						</select>
 					</div>
					<div class="form-group">
			...
			<div class="col-sm-12 col-md-3">
				<div class="pull-right text-right">
					...
					<option value="monthpr_id|asc">รหัส น้อย - มาก</option><option value="monthpr_id|desc">รหัส มาก - น้อย</option><option value="monthpay|asc">เดือน ก - ฮ</option><option value="monthpay|desc">เดือน ฮ - ก</option><option value="rf_name_id|asc">รหัสพนักงาน ก - ฮ</option><option value="rf_name_id|desc">รหัสพนักงาน ฮ - ก</option>
						</select>
 					</div>
				</div>
			</div>
			...
			<table class="table table-bordered table-striped table-hover">
				<thead class="info">
					<tr bgcolor="#dddddd">
						...
						<th>เดือน</th>
						<th>ชื่อพนักงาน</th>
						<th>ยอดเงินคิดประกันสังคมประจำเดือน</th>
						<th>ยอดเงินหักประกันสังคมประจำเดือนส่วนพนง</th>
						<th>ยอดเงินหักประกันสังคมประจำเดือนส่วนนายจ้าง</th>
							...
							<div class="btn-group pull-right">
								...
								<a href="javascript:void(0);" class="btn-delete-row my-tooltip btn btn-danger btn-sm"
									data-toggle="tooltip" title="ลบรายการนี้"
									 data-monthpr_id = "{encrypt_monthpr_id}" data-row-number="{record_number}">
...
<label class="col-sm-3 text-right badge badge-warning" for="edit_remark">ระบุเหตุผล :</label>
					...
					<input type="hidden" name="encrypt_monthpr_id" />
